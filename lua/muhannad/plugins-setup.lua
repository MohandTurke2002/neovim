...
return packer.startup(function(use)
	...
	use({
		"goolord/alpha-nvim",
		config = function()
			require("alpha").setup(require("muhannad.plugins.main-page").config)
		end,
	})
